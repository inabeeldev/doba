...
>
  <head>
    ...
    <title>Dashboard | NatureCheckout</title>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ request()->is('admin/orders') || request()->is('admin/doba-orders') ? 'active' : '' }}">
                ...
                <ul class="menu-sub">
                    ...
                    <a href="{{ route('my-orders') }}" class="menu-link">
                        <div data-i18n="list">Orders List</div>
                    </a>
                    </li>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  <a href="{{ '/' }}" target="_blank" class="footer-link fw-bolder">ADevs</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
